...
public class DefaultFastFileStorageClient extends DefaultGenerateStorageClient implements FastFileStorageClient {
    ...
    public DefaultFastFileStorageClient(TrackerClient trackerClient, FdfsConnectionManager fdfsConnectionManager,ThumbImageConfig thumbImageConfig) {
        super(trackerClient, fdfsConnectionManager);
